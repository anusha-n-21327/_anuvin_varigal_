...
const Poems = () => {
  return (
    <div className="min-h-screen w-full p-4 sm:p-8 font-serif text-gray-800">
      <div className="max-w-5xl mx-auto">
        <Link to="/" className="inline-flex items-center text-lg hover:text-black mb-8 group">
          <ArrowLeft className="w-5 h-5 mr-2 transition-transform group-hover:-translate-x-1" />
          Back to Home
        </Link>
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-12">Anu's Poems</h1>
