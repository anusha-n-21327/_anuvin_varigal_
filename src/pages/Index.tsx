...
const Index = () => {
  ...
  return (
    <div className="w-full min-h-screen font-serif text-gray-200 glow-container">
      {/* Header */}
        ...
        <section id="about" className="py-20 bg-black/20">
          <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center">
              <img src="/logo.jpeg" alt="Anu" className="h-64 w-64 rounded-full object-cover shadow-2xl border-4 border-slate-700" />
            </div>
          </div>
        </section>
