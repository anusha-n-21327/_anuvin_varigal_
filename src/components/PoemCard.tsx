...
import { Flower2 } from 'lucide-react'; // Reverted to Flower2
...
const PoemCard = ({ poem }: PoemCardProps) => {
  ...
  return (
    <div
      ...
      onMouseEnter={handleMouseEnter} // Reverted to onMouseEnter
      onMouseLeave={handleMouseLeave} // Reverted to onMouseLeave
    >
      <div
        className={cn(
      ...
      >
        ...
        <div className={cn(
          ...
          <Flower2 className="w-12 h-12 text-primary/50 mb-4 transition-transform group-hover:scale-110" /> {/* Reverted icon */}
          <p className="text-lg font-semibold text-muted-foreground">Hover to Reveal Poem</p> {/* Reverted prompt */}
        </div>
